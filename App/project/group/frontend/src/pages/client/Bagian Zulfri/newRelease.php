...
if (isset($_POST['submit'])) {
    ...
    if (!empty($songId) && !empty($playlistId)) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            echo "<script>alert('Song added to playlist successfully!'); window.location.href = 'newRelease.php';</script>";
        } else {
            // Jika gagal, tampilkan pesan error
            echo "<script>alert('Failed to add song to playlist.'); window.location.href = 'newRelease.php';</script>";
        }
    } else {
        // Jika data tidak lengkap, tampilkan pesan error
        echo "<script>alert('Data not complete.'); window.location.href = 'newRelease.php';</script>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        * {
        ...
        .song-list td.aksi div.poke {
            display: flex;
        }

        .song-list td.aksi div.poke i {
            margin: auto;
            font-size: 1.3rem;
        }
        ...
        <div class="main-content">
            <div class="header">
                <div class="search-bar">
                    ...
                    <input placeholder="Search a new song...." type="text" id="keyword" autocomplete="off">
                </div>
            </div>
            <div>
                <h1>Discover New Release</h1>
            </div>
            <div id="song-list">
