  ...
  <div class="content">
    ...
    <form action="#" method="POST" id="editProfile">
      <div class="flex gap-2 w-1/2 mx-auto mt-10 gap-5 flex-col rounded-md 
        ...
        <input type="date" name="birthDate" id="birthDate" class="rounded-md p-2">
        <label for="phoneNumber" class="text-white font-bold">Phone Number</label>
        <input type="text" name="phoneNumber" id="phoneNumber" class="rounded-md p-2" placeholder="Enter your phone number" value="<?= $client['phoneNumber'] ?? '' ?>">
        <label for="profilePicture" class="text-white font-bold">Profile Picture</label>
        <input type="file" name="profilePicture" id="profilePicture" class="rounded-md p-2 text-white">
