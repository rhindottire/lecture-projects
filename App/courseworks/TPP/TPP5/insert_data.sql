...
INSERT INTO supplier (nama, telp) VALUES
  ('PT Sumber Jaya', '081234567000'),
  ('CV Mitra Abadi', '081234567001'),
  ('Toko Elektronik Surabaya', '081234567002'),
  ('UD Sumber Makmur', '081234567003'),
  ('PT Surya Lestari', '081234567004'),
  ('CV Berkah Utama', '081234567005'),
  ('UD Sumber Sejahtera', '081234567006'),
  ('PT Maju Bersama', '081234567007'),
  ('CV Prima Mandiri', '081234567008'),
  ('Toko Cahaya Elektronik', '081234567009');
